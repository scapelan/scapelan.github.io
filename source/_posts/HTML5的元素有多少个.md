---
title: HTML5的元素有多少个
date: 2018-03-21 20:25:03
tags: HTML
---
HTML5的标签有多少个，看到这样的问题好像还从来没有一点概念，其实HTML5的标签只有106个(不包括已废弃，以及实验性质的标签)
<!-- more -->
# HTML的元素有多少个
详细列表及用法可查看[MDN](https://developer.mozilla.org/zh-CN/docs/Web/Guide/HTML/HTML5/HTML5_element_list)
...
'a' 'em' 'strong' 'small' 's' 'cite' 'q' 'dfn' 'abbr' 'data' 'time' 'code' 'var' 'samp' 'kbd' 'sub,sup' 'i' 'b' 'mark' 'ruby' 'rt' 'rp' 'bdi' 'bdo' 'span' 'br' 'wbr'
...
'form' 'fieldset' 'legend' 'label' 'input' 'button' 'select' 'datalist' 'optgroup' 'option' 'textarea' 'keygen' 'output' 'progess' 'meter'

'details' 'summary' 'menuitem' 'menu' 

用法快速查看[参考来源](http://mobilesite.github.io/2015/09/02/use-of-all-html5-elements/)
```html
<!DOCTYPE html>
<html lang="en">
...
```
参考链接：[HTML5标签列表](https://developer.mozilla.org/zh-CN/docs/Web/Guide/HTML/HTML5/HTML5_element_list)
